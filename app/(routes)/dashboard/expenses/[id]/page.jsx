...
function ExpensesScreen({ params }) {
  ...
  return (
    <div className="p-4 md:p-8 bg-[#ECF8FF] min-h-screen rounded-2xl shadow-lg border border-[#B3E5FC] transition-all duration-300 hover:shadow-blue-300 flex flex-col gap-6">
      <h2 className="text-2xl md:text-4xl font-bold flex justify-between items-center text-gray-800 drop-shadow-md">
        <span className="flex gap-2 items-center">
          <ArrowLeft onClick={() => route.back()} className="cursor-pointer text-blue-500 hover:text-blue-700 transition-transform transform hover:-translate-x-1" />
          My Expenses
        </span>
        <div className="flex gap-2 md:gap-3 items-center">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button className="flex gap-2 rounded-full bg-red-500 hover:bg-red-600 text-white px-3 md:px-4 py-1.5 md:py-2 font-medium shadow-md transform hover:scale-105">
                <Trash className="w-4" /> Delete
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
